...
public class RegisterNewPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the game code and set it in the right textView
        ...
        //Listener for switch activation (switching team and role)
        ...
        //On button click, gets entered value and start firebase sync
    ...
    private void updateDatabase() {
        ...
        gamesRef.addValueEventListener(valueListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                //Tries to find game key using gameCode
                if (foundGame == false)
                ...
                if (foundGame == true) {
                    ...
                    if (!playerRegistered && gameStatusDB.equals("WaitingForPlayers")) {
                        ...
                        if (nReadyPlayers >= nExpectedPlayers) {
                            ...
                            //If both master are registered and the selected role is master, sen info toast
                            ...
                            }//If master is already selected for selected team, send toast
                            ...
                            }//Checks to make sure both teams have a master, otherwise send toasts
                                ...
                                //If all conditions are ok, add player to firebase, disable editView and updates number of ready players
                                ...
                                //If all player are ready, start next phase
                                if (nReadyPlayers == nExpectedPlayers) {
                    ...
                    //Player is registered and all players are ready => start rules Recall
